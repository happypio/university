...
(define (nth-root n x)
  (define damping (truncate (log n 2)))
...
;(nth-root (power 6 10) 10)
;(nth-root (power 6 15) 15)
;(nth-root (power 6 25) 25)
;(nth-root (power 6 40) 40)
;(nth-root (power -6 13) 13)
;(nth-root (power 23 43) 43)
;(nth-root (power -33 19) 19)
